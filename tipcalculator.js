...
function totalCalcAmount() {
  ...
  document.getElementById("total").innerHTML = "$" + totalAmount + "select";
...
function otherTipCalcPercentAmount() {
  ...
  document.getElementById("tipamountpercent").disabled = false;
}
  ...
  document.getElementById("totalpercent").innerHTML = "$" + totalAmount + "percent";
...
function otherTipCalcDollarAmount() {
  ...
  if(tipTypeDollar.checked = true) {
    document.getElementById("tipamountdollar").disabled = false;
  }

  document.getElementById("totaldollar").innerHTML = "$" + totalAmount + "dollar";
